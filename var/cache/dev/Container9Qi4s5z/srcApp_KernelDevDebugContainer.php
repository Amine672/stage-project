...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'lexik_paybox.direc_plus.request_handler' => 'getLexikPaybox_DirecPlus_RequestHandlerService.php',
            'lexik_paybox.request_cancellation_handler' => 'getLexikPaybox_RequestCancellationHandlerService.php',
            'lexik_paybox.request_handler' => 'getLexikPaybox_RequestHandlerService.php',
            'lexik_paybox.response_handler' => 'getLexikPaybox_ResponseHandlerService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('18N+cqjFwW', 0, ($this->targetDirs[0].'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9b8tHc4odb', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CVMLKaqHFs', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9xTbRzIGEl', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hzHn+B9Wra', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('62dda6BjcG', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getTwig_Loader_NativeFilesystemService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/easycorp/easyadmin-bundle/src/Resources/views'), '!EasyAdmin');
        $instance->addPath(($this->targetDirs[3].'/vendor/lexik/paybox-bundle/Resources/views'), 'LexikPaybox');
        $instance->addPath(($this->targetDirs[3].'/vendor/lexik/paybox-bundle/Resources/views'), '!LexikPaybox');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'LexikPayboxBundle' => [
                    'path' => ($this->targetDirs[3].'/vendor/lexik/paybox-bundle'),
                    'namespace' => 'Lexik\\Bundle\\PayboxBundle',
                ],
            ]; break;
            ...
            case 'lexik_paybox.parameters': $value = [
                'production' => false,
                'site' => '9999999',
                'rank' => '99',
                'login' => '999999999',
                ...
                'rang' => NULL,
                'cle' => NULL,
                'public_key' => ($this->targetDirs[3].'/vendor/lexik/paybox-bundle/DependencyInjection/../Resources/config/paybox_public_key.pem'),
            ]; break;
